...
import { updateproductDetails } from "@/redux/features/product-details"; // Ensure this path is correct
...
const ShopWithSidebar = () => {
  ...
  const categories = [
    { name: "Edible", products: 3, isRefined: true },
    { name: "Medicinal", products: 2, isRefined: false },
    { name: "Tinctures", products: 2, isRefined: false },
  ];
      ...
      <section className="overflow-hidden relative pb-20 pt-5 lg:pt-20 xl:pt-28 bg-[#f3f4f6]">
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-7.5">
            ...
            >
              {/* THIS IS THE RESTORED SIDEBAR CONTENT */}
              <button
