        ...
        <div className={`absolute right-0 bottom-0 flex flex-col gap-2 p-5.5 ease-linear duration-300 ${
          ...
          {item.inStock ? (
            <>
              ...
              <button onClick={handleItemToWishList} aria-label="button for add to fav" className="flex items-center justify-center w-9 h-9 rounded-[5px] shadow-1 ease-out duration-200 text-dark bg-white hover:text-white hover:bg-blue">
                <svg className="fill-current" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
