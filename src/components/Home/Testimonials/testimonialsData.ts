...
const testimonialsData: Testimonial[] = [
  {
    review: `Absolutely thrilled with the freshness of the oyster mushrooms! As a chef, quality is everything. The delivery was prompt, right to my restaurant here in Dehradun. Kosvana is a game-changer.`,
  ...
  {
    review: `Fast, fresh, and fantastic. Their packaging is also eco-friendly, which I really appreciate. Kosvana has become my go-to for all my exotic mushroom needs.`,
