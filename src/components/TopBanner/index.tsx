...
const FALLBACK = [
    ...
    "Use code MUSHMUSH10 for 10% off your first order",
    "100% Natural & Sustainably Grown Mushrooms",
];
...
const TopBanner = () => {
    ...
    return (
        <div className="bg-[#1a1a1a] text-white w-full fixed top-0 left-0 z-[99999]">
            <div className="max-w-[1200px] mx-auto px-4 h-10 flex items-center">
                {/* Left – phone number */}
                <a
                    href="tel:+917618362662"
                    className="hidden md:flex items-center gap-1.5 text-white/70 hover:text-white transition-colors flex-shrink-0"
                >
                ...
                <div className="flex-1 flex items-center justify-center relative">
                    ...
                    <p className="text-[12px] tracking-wide text-center px-6">
                        {messages[activeIdx]}
                    </p>
                    {total > 1 && (
                        <button
                ...
                {/* Right – spacer to balance phone on left */}
                <div className="hidden md:block flex-shrink-0 w-[160px]"></div>
            </div>
        </div>
    );
};
