...
\restrict 3Kz1GznXqPb974ripHMiGcfmDvhTsYfknrpOEXsFhvW0R4ASHm8TgeiBa4cYe0P
...
--
-- Name: instructors; Type: TABLE; Schema: public; Owner: prisma_migration
--
...
ALTER TABLE public.instructors OWNER TO prisma_migration;

--
-- Name: instructors_id_seq; Type: SEQUENCE; Schema: public; Owner: prisma_migration
--
...
ALTER SEQUENCE public.instructors_id_seq OWNER TO prisma_migration;

--
-- Name: instructors_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: prisma_migration
--
...
--
-- Name: training_schedules; Type: TABLE; Schema: public; Owner: prisma_migration
--
...
ALTER TABLE public.training_schedules OWNER TO prisma_migration;

--
-- Name: training_schedules_id_seq; Type: SEQUENCE; Schema: public; Owner: prisma_migration
--
...
ALTER SEQUENCE public.training_schedules_id_seq OWNER TO prisma_migration;

--
-- Name: training_schedules_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: prisma_migration
--
...
--
-- Name: instructors id; Type: DEFAULT; Schema: public; Owner: prisma_migration
--
...
--
-- Name: training_schedules id; Type: DEFAULT; Schema: public; Owner: prisma_migration
--
...
7a3a24b9-e2a6-49ef-95c4-ddaab760949e	a65b40995f8ce8d2c9a77e93e1fdf371b5caea7fc2dfbe2b4e46093974f4cfb9	2025-09-17 09:58:29.054949+00	20250917083022_add_training_schedule	\N	\N	2025-09-17 09:58:28.96261+00	1
30550478-53ed-46ad-be85-4e039cc448aa	4238e40135c73a0e9cebb29165e9bf23b02e7a9ce6556afe368f31b3e99952ed	2025-09-17 09:58:29.121322+00	20250917092535_add_instructor_model	\N	\N	2025-09-17 09:58:29.070728+00	1
\.
...
4	Dry Powder	powders	/images/categories/powders.png	/shop?category=powders	Dried mushroom powders and supplements	2025-09-02 04:50:49.677	2025-09-14 08:24:25.518
2	Tinctures	tinctures	/images/categories/generic_tincture.png	/shop?category=tinctures	Concentrated mushroom tinctures and extracts	2025-09-02 04:50:49.677	2025-09-14 08:24:25.518
1	Edible	edible	/images/categories/edible_mushrooms.png	/shop?category=edible	Fresh edible mushrooms for culinary use	2025-09-02 04:50:49.677	2025-09-14 08:24:25.518
3	Medicinal	medicinal	/images/categories/medicinal_mushrooms.png	/shop?category=medicinal	Medicinal mushrooms for health and wellness	2025-09-02 04:50:49.677	2025-09-14 08:24:25.518
7	All Mushrooms	all-mushrooms	/images/categories/mushrooms.png	/shop	Complete collection of all mushroom varieties	2025-09-15 15:25:48.06	2025-09-15 15:25:48.06
8	Spat/Spawn	spat-spawn	/images/categories/spat_spawn.png	/shop?category=spat-spawn	Mushroom spawn and spore cultures for cultivation	2025-09-17 06:49:02.774	2025-09-17 07:21:56.51
\.


--
-- Data for Name: instructors; Type: TABLE DATA; Schema: public; Owner: prisma_migration
--

COPY public.instructors (id, name, email, phone, bio, expertise, experience, "isActive", "createdAt", "updatedAt") FROM stdin;
1	Vikrant Rai	vikrant.rai@mushmush.com	+91 98765 43210	Expert in oyster mushroom cultivation with over 8 years of experience in commercial mushroom farming. Specializes in sustainable cultivation techniques and yield optimization.	Oyster Mushroom Cultivation, Commercial Farming, Sustainable Agriculture	8	t	2025-09-17 10:27:04.238	2025-09-17 10:27:04.238
2	Pravesh Rawat	pravesh.rawat@mushmush.com	+91 98765 43211	Specialist in button and shiitake mushroom cultivation with 10+ years of experience. Expert in spawn production, substrate preparation, and disease management.	Button Mushroom, Shiitake Mushroom, Spawn Production, Disease Management	10	t	2025-09-17 10:27:05.448	2025-09-17 10:27:05.448
\.
...
cmf3zymzx0001jq05h5myzx9w	2025-09-03 13:12:26.35	2025-09-15 14:08:01.43	cmf2rtavq0001l504oy7lle1e	4
cmf403vl60003ic04uoqz1s7h	2025-09-03 13:16:30.763	2025-09-15 14:16:36.376	cmf2rtavq0001l504oy7lle1e	1
cmfntpnwd0001jr04lnsz1axi	2025-09-17 10:12:53.437	2025-09-17 10:21:12.127	cmfiiwshp0000jx04hy1n4esx	1
\.
...
1	Oyster Mushroom Training	oyster-mushroom-training	dsfsadfasfldsakjf	5000	10	5-6 Hours 	OYSTER	t	2025-09-13 17:17:07.529	2025-09-15 14:11:25.083
\.
...
cmfl7e7ng0003jr04yl5lahz8	TR1757945555259432	PENDING	Bhartendu	bharu310194@gmail.com	8445528589	{"city": "Dehradun", "state": "Uttrakhand", "street": "Bhaniyawala", "pincode": "248001"}	2025-09-22 00:00:00		5000	2025-09-15 14:12:35.26	2025-09-15 14:12:35.26	1	cmf2rtavq0001l504oy7lle1e	\N	\N	\N	PENDING	\N
\.


--
-- Data for Name: training_schedules; Type: TABLE DATA; Schema: public; Owner: prisma_migration
--
...
cmfnt2t350000uucz6u98zlap	test@example.com	Test User	2025-09-17 09:55:07.074	2025-09-17 09:55:07.074	\N	\N	\N	\N	CUSTOMER	$2b$12$9sU/j/wqA7QXtqooigQbNu4wfn.y5SZYv1.NsxbgoZtw3C0JnVwzO	\N	\N
\.
...
--
-- Name: instructors_id_seq; Type: SEQUENCE SET; Schema: public; Owner: prisma_migration
--
...
--
-- Name: training_schedules_id_seq; Type: SEQUENCE SET; Schema: public; Owner: prisma_migration
--

SELECT pg_catalog.setval('public.training_schedules_id_seq', 1, false);
...
--
-- Name: instructors instructors_pkey; Type: CONSTRAINT; Schema: public; Owner: prisma_migration
--
...
--
-- Name: training_schedules training_schedules_pkey; Type: CONSTRAINT; Schema: public; Owner: prisma_migration
--
...
--
-- Name: instructors_email_key; Type: INDEX; Schema: public; Owner: prisma_migration
--
...
--
-- Name: instructors_name_key; Type: INDEX; Schema: public; Owner: prisma_migration
--
...
--
-- Name: training_schedules training_schedules_instructorId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: prisma_migration
--
...
--
-- Name: training_schedules training_schedules_trainingProgramId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: prisma_migration
--
...
\unrestrict 3Kz1GznXqPb974ripHMiGcfmDvhTsYfknrpOEXsFhvW0R4ASHm8TgeiBa4cYe0P
