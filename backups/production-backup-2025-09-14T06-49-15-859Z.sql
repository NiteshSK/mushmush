...
\restrict E3XsfAlxIxLRgM2Ob0jE0l4ZfdSxHcp1r5c1sDhO6AZX6v8Zu3bBO04Rv6aMdJJ
...
0dfff5a7-ae0c-4af5-957d-894abd1aeddc	27165e6a591b55e679f3e4bd2064034abce10814712ba6864c99ff255afd16ea	\N	20250913172210_fix_category_paths	A migration failed to apply. New migrations cannot be applied before the error is recovered from. Read more about how to resolve migration issues in a production database: https://pris.ly/d/migrate-resolve\n\nMigration name: 20250913172210_fix_category_paths\n\nDatabase error code: 42P01\n\nDatabase error:\nERROR: relation "Category" does not exist\n\nPosition:\n[1m  0[0m\n[1m  1[0m -- Fix category paths to use /shop instead of /shop-without-sidebar\n[1m  2[0m -- This migration updates the paths in the Category table to fix 404 errors\n[1m  3[0m\n[1m  4[0m -- Update All Mushrooms category path\n[1m  5[1;31m UPDATE "Category" SET "path" = '/shop' WHERE "slug" = 'all-mushrooms';[0m\n\nDbError { severity: "ERROR", parsed_severity: Some(Error), code: SqlState(E42P01), message: "relation \\"Category\\" does not exist", detail: None, hint: None, position: Some(Original(191)), where_: None, schema: None, table: None, column: None, datatype: None, constraint: None, file: Some("parse_relation.c"), line: Some(1449), routine: Some("parserOpenTable") }\n\n   0: sql_schema_connector::apply_migration::apply_script\n           with migration_name="20250913172210_fix_category_paths"\n             at schema-engine/connectors/sql-schema-connector/src/apply_migration.rs:113\n   1: schema_commands::commands::apply_migrations::Applying migration\n           with migration_name="20250913172210_fix_category_paths"\n             at schema-engine/commands/src/commands/apply_migrations.rs:95\n   2: schema_core::state::ApplyMigrations\n             at schema-engine/core/src/state.rs:236	\N	2025-09-13 17:30:33.32641+00	0
\.
...
3	Medicinal	medicinal	/images/categories/medicinal_mushrooms.png	/shop?category=medicinal	Medicinal mushrooms for health and wellness	2025-09-02 04:50:49.677	2025-09-13 18:28:01.913
4	Dry Powder	powders	/images/categories/powders.png	/shop?category=powders	Dried mushroom powders and supplements	2025-09-02 04:50:49.677	2025-09-13 18:28:01.913
2	Tinctures	tinctures	/images/categories/generic_tincture.png	/shop?category=tinctures	Concentrated mushroom tinctures and extracts	2025-09-02 04:50:49.677	2025-09-13 18:28:01.913
1	Edible	edible	/images/categories/edible_mushrooms.png	/shop?category=edible	Fresh edible mushrooms for culinary use	2025-09-02 04:50:49.677	2025-09-13 18:28:01.913
\.
...
1	Oyster Mushroom Training	oyster-mushroom-training	dsfsadfasfldsakjf	5000	10	5-6 Hours 	OYSTER	f	2025-09-13 17:17:07.529	2025-09-13 17:19:32.295
\.
...
\unrestrict E3XsfAlxIxLRgM2Ob0jE0l4ZfdSxHcp1r5c1sDhO6AZX6v8Zu3bBO04Rv6aMdJJ
